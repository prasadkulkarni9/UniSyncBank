<div align="center">
  ...
  <h2 align="center">UniSyncBank : Connect.Track.Save.</h2>
...
Built with Next.js, UniSyncBank  is a financial SaaS platform that connects to multiple bank accounts, displays transactions in real-time, allows users to transfer money to other platform users, and manages their finances altogether. 
...
```bash
git clone git clone https://github.com/prasadkulkarni9/UniSyncBank.git
cd banking
```
...
export const createLinkToken = async (user: User) => {
  try {
    ...
    console.error(
      "An error occurred while creating a new UniSyncBank user:",
      error
    );
  }
};
